  ...
  render: function () {
    ...
    var addButton = (
      React.createElement("button", {className: "btn btn-default btn-success", onClick: this.createItem}, 
        ...
        React.createElement("span", null, " New ", title, "…")
      )
    );
    var filterCtrl = (
    ...
    var editColumn = function (row, i) {
      ...
      if (actions) {
        return (
          React.createElement("td", {key: 'edit-' + row.id, className: "action-edit"}, 
            React.createElement("div", {className: "dropdown"}, 
              ...
              React.createElement("ul", {className: "dropdown-menu dropdown-menu-right", role: "menu", "aria-labelledby": 'actions_' + i}, 
                ...
                actions.map(function (action, j) {
                  ...
                  return (
                    React.createElement("li", {key: j, role: "presentation"}, 
    ...
    var deleteColumn = function (row) {
      return (
        React.createElement("td", {key: 'delete-' + row.id, className: "action-delete"}, React.createElement("input", {className: "item-delete", type: "checkbox", alt: "Check to delete", title: "Check to delete"}))
      )
    };
    // var deleteButton = (
              ...
              React.createElement("tr", {key: row.id}, 
                this.props.projection.map(function (column, j) {
                  ...
                  if (this.props.editable && column === nameColumn) {
                    return (
                      React.createElement("td", {key: j}, React.createElement("a", {href: "#", onClick: this.editItem.bind(this, i)}, value))
                    );
                  } else {
                    return (
                      React.createElement("td", {key: j}, value)
                    );
                  }
                }.bind(this)), 
