...
var Form = React.createClass({displayName: "Form",
  ...
  render: function () {
    ...
    var submitButton = (
      React.createElement("button", {ref: "submitBtn", type: "button", className: "btn btn-default", 
              onClick: this.handleSubmit, "data-loading-text": "Updating...", 
              autoComplete: "off"}, "Save")
    );
    if (formType === 'horizontal') {
      return (
        React.createElement("form", {id: this.props.name + '-form', ref: this.props.name + '-form', role: "form", className: "form-horizontal"}, 
          fields, 
      ...
      return (
        React.createElement("form", {id: this.props.name + '-form', ref: this.props.name + '-form', role: "form"}, 
          fields, 
          submitButton
        )
      );
        ...
        if (i == 0) {
          li = (
            React.createElement("li", {role: "presentation", className: "active"}, 
              React.createElement("a", {href: '#' + tab.id, "aria-controls": tab.id, role: "tab", "data-toggle": "tab"}, tab.title)
            )
          );
          pane = (
            React.createElement("div", {role: "tabpanel", className: "tab-pane active", id: tab.id}, 
              fields
            )
          );
        } else {
          ...
          pane = (
            React.createElement("div", {role: "tabpanel", className: "tab-pane", id: tab.id}, 
              fields
            )
          );
        }
