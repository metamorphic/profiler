...
export default class OracleSourceForm extends React.Component {
  ...
  render() {
    return (
      <form id={this.props.name + '-form'} ref={this.props.name + '-form'} role="form" className="form-horizontal">
        ...
        <div className="form-group">
          <label htmlFor="descriptor-type" className="col-sm-4 control-label">Descriptor Type</label>
          <div className="col-sm-8">
            <select className="form-control" id="descriptor-type"
                   name="descriptor-type" placeholder="Descriptor type" value={this.state.form.descriptorType}
                    onChange={this.handleChange.bind(this, 'descriptorType')}>
